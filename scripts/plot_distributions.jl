...
ax1 = MK.Axis(fig[1, 1]; title="Exponential", xlabel="depth / m", ylabel="probability density")
ax2 = MK.Axis(fig[1, 2]; title="Mixture", xlabel="depth / m", limits=((0, nothing), nothing))
